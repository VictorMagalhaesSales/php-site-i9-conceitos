...
<body id="page-top">
				...
				<div  class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav pull-left" id="hover">
						<?php
							...
							echo "
							<li role='presentation'><a href='../index.php'><i class='fas fa-home'></i></i>&nbsp VOLTAR </a></li>
							<li role='presentation'><a type='button' class='modal-trigger' data-target='$modal' href=''><i class='fas fa-comments'></i></i>&nbsp Mensagens</a></li>
							";
	...
	<div class="perfil" style="background-color: white; margin-top: 7%; margin-left: 7%; margin-right: 7%; padding-bottom: 2%;">
		<div class="cabeca" style="background-color: #569efb; background:  linear-gradient(to left ,#436cda,#ff3578); padding-top: .4%; color: white;">
			...
			<h4 align="center"><a type='button' class='modal-trigger' data-target='modal1' href=''><i class="fas fa-edit"></i>&nbsp <b>EDITAR</b></a></h4>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<h3><i class="fab fa-facebook"></i> Facebook: </h3><?php echo "facebook.com/".$_SESSION['facebook']; ?>
				<h3><i class="fab fa-whatsapp"></i> Whatsapp: </h3><?php echo $_SESSION['whatsapp']; ?>
				<h3><i class="fab fa-instagram"></i> Instagram: </h3><?php echo "instagram.com/".$_SESSION['instagram']; ?>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			<div class="col s4 offset-s4">
				<center>
					<a type='button' class='modal-trigger btn-i9 waves-effect' data-target='historicocompras' href=''><i class='fas fa-sign-in-alt fa-1x'></i>&nbsp Histórico de compras</a>
				</center>
			</div>
		</div>
	</div>

	<div id="historicocompras" class="modal" style="font-family:Montserrat; width: 60%; height: 600px; overflow-x: hidden; padding: 20px;">
		<a type="button"  class="modal-action modal-close pull-right" style="margin: 2%;  color: #446bd9;"><i class="fas fa-times fa-2x"> </i> </a>
		<div class="row">
			<div class="col s10 offset-s1">
				<h1 align="center">Histórico de compras</h1><Br>
			 	<table class="table table-hover table-bordered">
					...
					<tbody>
						<?php 
							$result_pedidos = "SELECT * FROM pedidos where cdusuario=".$_SESSION['cdusuario'];
							$lista = mysqli_query($conn, $result_pedidos);
						 	while($informacoes = mysqli_fetch_assoc($lista)){
						?>		

						<tr>
							<td><?php echo $informacoes['produto']; ?></td>
							<td><?php echo $informacoes['data']; ?></td>
							<td><?php echo $informacoes['descricao']; ?></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
	...
	<div id="cIniciar" class="modal" style=" font-family:Montserrat; overflow-x: hidden; padding: 20px;">
		<a type="button"  class="modal-action modal-close pull-right" style="margin: 2%; color: #446bd9;"><i class="fas fa-times fa-2x"></i> </a>
		<div class="modal-content">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<h3 align="center">Você não iniciou o chat</h3>
					<br><br><br>
				</div>
				<form class="col-md-8 col-md-offset-2" action="ciniciar.php" method="post" style="border: 1px solid rgba(0,0,0,.1); padding: 30px;">
					<div class="input-field col s12">
			          <textarea id="iniciarchat" class="materialize-textarea" cols="10" rows="12" name="mensagem"></textarea>
			          <label for="iniciarchat">Digite aqui a sua primeira mensagem para o nosso suporte</label>
			        </div>
			        <center>
			        <button class="btn-i9">Enviar</button>
			        </center>
				</form>
			</div>	
		</div>
	...
	<div id="cIniciado" class="modal modal-fixed-footer" style="font-family:Montserrat; width: 60%; height: 80%;overflow-x: hidden; padding-left: 10px;">
		<a type="button" class="modal-action modal-close pull-right" style="margin: 2%; color: #446bd9;"><i class="fas fa-times fa-2x"></i></a>
		<div class="modal-content">
			<div class="row">	
