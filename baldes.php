			...
			<div  style="margin-left: 5%; padding-top: 12%;" >
			    ...
			    <div class="path-slider" >
			        ...
			        <a href="#chat" class="path-slider__item" >
			        	<input type="radio"  id="pro" value="Balde acrílico personalizado" name="produto" style="background: transparent; border: transparent;display: none;"></input>
			        	<label for="pro">
			        	<img src="img/p/b1.png" class="circle" id="img" style=" width: 130px; cursor: pointer;">
				        <div class="item__title"><h3 class="pink-text">Balde acrílico<br>personalizado</h3><h5 class="pink-text">R$ 35,00</h5></div>
				    	</label>
