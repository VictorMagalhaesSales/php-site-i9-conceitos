			...
			<div  style="margin-left: 5%; padding-top: 12%;" >
			    ...
			    <div class="path-slider" >
			        ...
			        <a href="#chat" class="path-slider__item" >
			        	<input type="radio"  id="pro" value="Caneca porcenala" name="produto" style="background: transparent; border: transparent;display: none;"></input>
			        	<label for="pro">
			        	<img src="img/c1.png" class="circle" id="img" style=" width: 130px; cursor: pointer;">
				        <div class="item__title"><h3 class="pink-text">Caneca porcenala<br>personalizada</h3><h5 class="pink-text">R$ 25,00</h5></div>
				    	</label>
			        </a>
			        <a href="#alarmclock" class="path-slider__item">
			        	<input type="radio"  id="pro2" value="Garrafa" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro2">
			            <img src="img/gar.png" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">Garrafa</h3><h5 class="pink-text">R$ 30,00</h5></div>
			            </label>
			        </a>
			        <a href="#camera" class="path-slider__item">
			        	<input type="radio"  id="pro3" value="Copos twister" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro3">
			            <img src="img/ct.png" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">Copos twister<br>(5 peças)</h3><h5 class="pink-text">R$ 7,00 unidade</h5></div>
			            </label>
			        </a>
			        <a href="#envelope" class="path-slider__item">
			        	<input type="radio"  id="pro4" value="Copos long" name="produto" style="background: transparent; border: transparent; display: none;">	</input>
			        	<label for="pro4">
			        	<img src="img/cl.png" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">Copos long<Br>(20 peças)</h3><h5 class="pink-text">R$ 2,80 unidade</h5></div>
			            </label>
			        </a>
			        <a href="#lightbulb" class="path-slider__item">
			        	<input type="radio"  id="pro5" value="Copos e canecas: outro" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro5">
