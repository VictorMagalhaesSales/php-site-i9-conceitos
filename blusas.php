			...
			<div  style="margin-left: 5%; padding-top: 12%;" >
			    ...
			    <div class="path-slider" >
			        ...
			        <a href="#chat" class="path-slider__item" >
			        	<input type="radio"  id="pro" value="Blusa personalizada branca" name="produto" style="background: transparent; border: transparent;display: none;"></input>
			        	<label for="pro">
			        	<img src="img/b4.jpg" class="circle" id="img" style=" width: 130px; cursor: pointer;">
				        <div class="item__title"><h3 class="pink-text">branca<br>personalizada</h3><h5 class="pink-text">R$ 32,00</h5></div>
				    	</label>
			        </a>
			        <a href="#alarmclock" class="path-slider__item">
			        	<input type="radio"  id="pro2" value="Blusa personalizada colorida" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro2">
			            <img src="img/b1.jpg" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">colorida<br>personalizada</h3><h5 class="pink-text">R$ 32,00</h5></div>
			            </label>
			        </a>
			        <a href="#camera" class="path-slider__item">
			        	<input type="radio"  id="pro3" value="Blusa personalizada 2 blusas" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro3">
			            <img src="img/b2.jpg" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">kit 2 blusas </h3><h5 class="pink-text">R$ 50,00</h5></div>
			            </label>
			        </a>
			        <a href="#envelope" class="path-slider__item">
			        	<input type="radio"  id="pro4" value="Uniformes" name="produto" style="background: transparent; border: transparent; display: none;">	</input>
			        	<label for="pro4">
			        	<img src="img/b3.jpg" class="circle" id="img" style=" width: 130px; cursor: pointer;">
			            <div class="item__title"><h3 class="pink-text">uniformes</h3><h5 class="pink-text">R$ 48,00</h5></div>
			            </label>
			        </a>
			        <a href="#lightbulb" class="path-slider__item">
			        	<input type="radio"  id="pro5" value="Blusas: outro" name="produto" style="background: transparent; border: transparent; display: none;"></input>
			        	<label for="pro5">
